...
if "id" in form:
    ...
    update_link = 'update.py?id={pageId}'.format(pageId=pageId)
...
<p><textarea rows="4" name="description" placeholder="description">{form_description}</textarea></p>
...
'''.format(title=pageId,des=description,liststr=liststr,update=update_link,form_title=pageId,form_description=description))
